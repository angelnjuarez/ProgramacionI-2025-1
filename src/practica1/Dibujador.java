...
public class Dibujador extends Panel 
{
	...
	/**
	 * Construye un dibujador con tama�o por defecto (800 x 800). 
	 */
	public Dibujador(){
		super();
		inicializar(800, 800);
	...
	/**
	 * Devuelve el alto del dibujador en p�xeles.
	 */
	public int alto()
	{
	...
	/**
	 * Devuelve el ancho del dibujador en p�xeles.
	 */
	public int ancho()
	{
	...
	/**
	 * Dibuja una l�nea en el dibujador entre las coordenadas dadas.
	 * @param desde Punto de inicio de la l�nea
	 * @param hasta Punto de final de la l�nea
	 */
